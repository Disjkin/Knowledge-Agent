"""
100 Query 测试脚本 — 针对个人知识库助手（《遥远的救世主》RAG + 网搜兜底）
...
QUERIES = {
    ...
    "A06": "欧阳雪开了什么店？",
    "A07": "韩楚风在书中扮演什么角色？",
    "A08": "冯世杰、叶小明、刘斌三人是什么关系？",
    "A09": "书中提到的'强势文化'和'弱势文化'分别指什么？",
    "A10": "丁元英的私募基金是在哪一年解散的？",
    "A11": "林雨峰是哪家公司的老板？",
    "A12": "书中'神即道，道法自然，如来'是什么意思？",
    "A13": "丁元英为什么选择在古城隐居？",
    "A14": "芮小丹向丁元英要了什么'礼物'？",
    "A15": "王庙村扶贫项目的核心思路是什么？",
    "A16": "书中提到的'文化属性'是什么意思？",
    "A17": "格律诗音响的音箱成本是多少？",
    "A18": "刘冰是一个怎样的人？结局如何？",
    "A19": "丁元英和韩楚风在酒店喝酒时讨论了什么？",
    "A20": "小说的结局是什么？",

    # ====== B. 网搜兜底 — 时事新闻（15题）======
    "B01": "2026年诺贝尔文学奖得主是谁？",
    "B02": "今天北京的天气怎么样？",
    "B03": "2026年世界杯足球赛冠军是哪个国家？",
    "B04": "特斯拉股价今天是多少？",
    "B05": "中国 2025 年 GDP 增长率是多少？",
    "B06": "苹果最新款 iPhone 什么时候发布？",
    "B07": "2026年巴黎奥运会金牌榜排名",
    "B08": "SpaceX 星舰最新发射时间",
    "B09": "比特币今天价格是多少？",
    "B10": "2026年春节是哪一天？",
...
async def main():
    ...
    async with httpx.AsyncClient() as client:
        ...
        # 保存完整结果到 JSON
        output_file = "test_100_queries_result.json"
